    ...
    <div style="height:620px; width:auto; background-color:#FFFFFF; margin-left:15px; margin-right:15px; padding:15px; border-color:#0F9; border:2px; border:solid">
        ...
        <div style="height:470px; width:auto;">
                ...
                <div style="height:250px; width:120px; float:right;  margin-top:10px">
                    <form action="#" method="post">
                        <table>
                            <tr>
                                <td>
                                    <a href="${pageContext.request.contextPath}/employee/employee.jsp?function=seeCustomer">查看顾客</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="${pageContext.request.contextPath}/employee/employee.jsp?function=seeRoom">查看房间</a>
                                </td>
                            </tr>
            ...
            <div style="height:470px; width:550px; background-color:#F8F8F8; float:right">
                ...
                <c:choose>
                    <c:when test="${rose.equals('seeCustomer') }">
                        <%@ include file="seeCustomer.jsp" %>

                    </c:when>
                    <c:when test="${rose.equals('seeRoom')  }">
                        <%@ include file="seeRoom.jsp" %>
                    </c:when>
