        ...
        <tr>
            <td>
                <div style="height:160px; width:auto;">
                    ...
                    <form action="customerLogin" method="post" style="margin:20px">
                        <table>
                            <tr class="main">
                                <td class="ch">用户名：</td>
                                <td><input type="text" name="user.cu_username" value="${user.cu_username }" size="20"/>
                                </td>
                            </tr>
                            <tr class="main">
                                <td class="ch">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
                                <td><input type="password" name="user.cu_password" size="20"/></td>
                            </tr>
                            <tr>
                                <td>
